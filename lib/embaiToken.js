...
const { createMint, getOrCreateAssociatedTokenAccount, mintTo, transfer, getAccount, burn } = require('@solana/spl-token');
...
// Export constants
module.exports.NEW_EMBAI_ADDRESS = NEW_EMBAI_ADDRESS;
module.exports.TRADING_FEE_DISCOUNT = TRADING_FEE_DISCOUNT;
module.exports.BURN_PERCENTAGE = BURN_PERCENTAGE;
module.exports.PREMIUM_FEATURES_THRESHOLD = PREMIUM_FEATURES_THRESHOLD;
module.exports.STAKING_REWARD_RATE = STAKING_REWARD_RATE;
module.exports.GRADUATION_TRADE_THRESHOLD = GRADUATION_TRADE_THRESHOLD;
module.exports.TOKEN_CONFIG = TOKEN_CONFIG;
module.exports.EMB_TOKEN_CONFIG = EMB_TOKEN_CONFIG;
module.exports.TOKEN_DISTRIBUTION = TOKEN_DISTRIBUTION;
module.exports.GOVERNANCE_CONFIG = GOVERNANCE_CONFIG;
module.exports.MIGRATION_BONUS_RATE = MIGRATION_BONUS_RATE;

// Export the class
module.exports = EMBAITokenManager;