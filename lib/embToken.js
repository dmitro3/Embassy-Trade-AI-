...
export const EMB_TOKEN_CONFIG = {
  ...
  // Standard RPC endpoints without API key for web3.js Connection object
  standardRpcEndpoints: {
    mainnet: 'https://api.mainnet-beta.solana.com',
    devnet: 'https://api.devnet.solana.com'
  },
  
  // RPC endpoints with API key for Shyft API calls
  rpcEndpoints: {
...
// Helper function to get the appropriate RPC endpoint for web3.js Connection
export const getStandardRpcEndpoint = (network = 'mainnet') => {
  return EMB_TOKEN_CONFIG.standardRpcEndpoints[network] || EMB_TOKEN_CONFIG.standardRpcEndpoints.mainnet;
};
